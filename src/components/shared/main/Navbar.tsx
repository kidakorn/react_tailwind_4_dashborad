...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      // If not close Menu onClick Button
      if (menuButtonRef.current?.contains(target)) {
        return;
      }

      // If Click OtherArea set Menu-off
  ...
  // renderDropdown items for mobile and Desktop navigation
